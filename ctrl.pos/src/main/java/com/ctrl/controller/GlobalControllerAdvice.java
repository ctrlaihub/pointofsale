...
public class GlobalControllerAdvice extends HandlerInterceptorAdapter {
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
		...
		if (!path.equals("/ctrlaihub/login1"))
			if (!(path.equals("/ctrlaihub/") || (path.equals("/ctrlaihub/") ||
					  path.equals("/ctrlaihub/dashAssets/images/hema%20logo.png") ||
					  ...
					  path.equals(
					  "/ctrlaihub/dashAssets/plugins/jquery-validation/jquery.validate.js") )
					 )) {
